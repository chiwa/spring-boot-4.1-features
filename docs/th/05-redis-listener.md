...
ลด Boilerplate ในการทำ Redis Pub/Sub Listener และทำให้ Configuration เป็นมาตรฐานมากขึ้น

## Objective

เป้าหมายคืออธิบายว่า Redis Listener Auto Configuration แก้ปัญหาเชิงวิศวกรรมอะไร ไม่ใช่แค่เปิดใช้งานอย่างไร
...
ดู Code ตัวอย่างได้ที่ `modules/05-redis-listener`
