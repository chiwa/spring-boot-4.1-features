...
ช่วยให้ Health/Info Endpoint ให้ข้อมูล Runtime ที่ใช้ตรวจสอบระบบได้ดีขึ้น

## Objective

เป้าหมายคืออธิบายว่า Actuator Info Improvements แก้ปัญหาเชิงวิศวกรรมอะไร ไม่ใช่แค่เปิดใช้งานอย่างไร
...
ดู Code ตัวอย่างได้ที่ `modules/07-actuator-info`
