...
เพิ่มความพร้อมด้าน Monitoring, Tracing และ Observability สำหรับระบบ Production

## Objective

เป้าหมายคืออธิบายว่า OpenTelemetry & Observability แก้ปัญหาเชิงวิศวกรรมอะไร ไม่ใช่แค่เปิดใช้งานอย่างไร
...
ดู Code ตัวอย่างได้ที่ `modules/04-observability-opentelemetry`
