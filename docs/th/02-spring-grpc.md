...
Spring Boot 4.1 ทำให้ gRPC เป็น First-class Citizen มากขึ้น ทั้ง Server, Client, Testing และ Observability

## Objective

เป้าหมายคืออธิบายว่า Spring gRPC Support แก้ปัญหาเชิงวิศวกรรมอะไร ไม่ใช่แค่เปิดใช้งานอย่างไร
...
ดู Code ตัวอย่างได้ที่ `modules/02-spring-grpc`
