...
ทำให้การตั้งค่า Serialization/Deserialization ชัดเจนและจัดการได้ง่ายขึ้น

## Objective

เป้าหมายคืออธิบายว่า Jackson Configuration Improvements แก้ปัญหาเชิงวิศวกรรมอะไร ไม่ใช่แค่เปิดใช้งานอย่างไร
...
ดู Code ตัวอย่างได้ที่ `modules/06-jackson-configuration`
