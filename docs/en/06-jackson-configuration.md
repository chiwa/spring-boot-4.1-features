# Jackson Configuration Improvements

> Module: `modules/06-jackson-configuration`

## Introduction

Spring Boot 4.1 updates Jackson configuration properties and customization support.

## Objective

The objective is to show how Jackson Configuration Improvements solves a real engineering problem, not just how to enable it.
...
See `modules/06-jackson-configuration` for runnable code.
