...
> Module: `modules/08-async-context-propagation`

## Introduction

Spring Boot 4.1 improves propagation of observation context for asynchronous execution.

## Objective

The objective is to show how Async Context Propagation solves a real engineering problem, not just how to enable it.
...
See `modules/08-async-context-propagation` for runnable code.
