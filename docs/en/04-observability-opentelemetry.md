...
> Module: `modules/04-observability-opentelemetry`

## Introduction

Spring Boot 4.1 improves observability integration, especially around OpenTelemetry and context propagation.

## Objective

The objective is to show how OpenTelemetry & Observability solves a real engineering problem, not just how to enable it.
...
See `modules/04-observability-opentelemetry` for runnable code.
