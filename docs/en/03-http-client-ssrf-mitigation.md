...
Spring Boot 4.1 introduces HTTP client SSRF mitigation using address filtering for outbound calls.

## Objective

The objective is to show how HTTP Client SSRF Mitigation solves a real engineering problem, not just how to enable it.
...
See `modules/03-http-client-ssrf-mitigation` for runnable code.
