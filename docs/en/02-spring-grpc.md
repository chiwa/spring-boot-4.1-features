...
> Module: `modules/02-spring-grpc`

## Introduction

Spring Boot 4.1 provides first-class support for building and testing gRPC server and client applications.

## Objective

The objective is to show how Spring gRPC Support solves a real engineering problem, not just how to enable it.
...
See `modules/02-spring-grpc` for runnable code.
